...
const LoansPage = () => {
  ...
  // Map modular steps to legacy UI steps
  // currentStep 1-2: request, 3: summary, 4-7: address
  const activeStep = currentStep <= 2 ? "request" : currentStep === 3 ? "summary" : "address";

  const handleRequestProceed = () => {
    nextStep();
    if (activeStep === "request") {
       // Optional: simulate logic if needed, but nextStep() handles it
    }
  };
...
const LoanRequestView = ({
  ...
  const { loanDetails, setLoanField } = useLoanStore();
  ...
  const isValid = loanDetails.amount && loanDetails.purpose && loanDetails.duration;
            ...
            <div className="space-y-1">
              <div className="relative">
                ...
                <input
                  ...
                  onChange={(e) => setLoanField("amount", e.target.value)}
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <select
                ...
                onChange={(e) => setLoanField("purpose", e.target.value)}
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              <select
                ...
                onChange={(e) => setLoanField("duration", e.target.value)}
                className="w-full bg-[#FBFBFB] border border-gray-100 rounded-xl p-4 outline-none focus:border-[#FF8A00] transition-all appearance-none font-medium">
                <option value="" disabled>
                  Select a tenor
                </option>
...
const LoanSummaryView = ({ onProceed }: { onProceed: () => void }) => {
  ...
  const summaryDetails = [
    { label: "Amount you will receive", value: `₦ ${loanDetails.amount}` },
    { label: "Loan amount", value: "₦ 1,050,000" },
    { label: "Monthly flat interest rate", value: "2.5%" },
    { label: "Loan duration", value: loanDetails.duration },
...
const LoanAddressView = ({ onProceed }: { onProceed: () => void }) => {
  const { address, setAddressField } = useLoanStore();
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          <div className="space-y-2">
            ...
            <input
              ...
              onChange={(e) => setAddressField("houseAddress", e.target.value)}
              className="w-full bg-[#FBFBFB] border border-gray-100 rounded-xl p-4 outline-none focus:border-[#FF8A00] transition-all font-medium"
        ...
        <div className="grid grid-cols-2 gap-6">
          <div className="space-y-2">
            ...
            <div className="relative">
              <select
                value={address.lga}
                onChange={(e) => setAddressField("lga", e.target.value)}
                className="w-full bg-[#FBFBFB] border border-gray-100 rounded-xl p-4 outline-none focus:border-[#FF8A00] transition-all appearance-none font-medium">
                <option value="" disabled>
                  Select an option
                </option>
