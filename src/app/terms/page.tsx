  ...
  return (
    <div className="min-h-screen bg-[#050505] text-white/80 pb-20">
      ...
      <div className="max-w-3xl mx-auto px-6 mt-16">
        <div className="mb-12">
          <h1 className="text-4xl font-bold text-white mb-4">Terms and Conditions for Peakpay</h1>
          <p className="text-white/60 text-lg">Last updated: August 2026</p>
        </div>

        <div className="space-y-8 text-lg leading-relaxed font-light">
          <p>
            These Terms and Conditions (including our Privacy Policy) describe how Peakpay, operated by Smart City Limited (“we,” “us,” or
            “our”), provides its mobile application, website, and related services
          ...
          <div className="space-y-4">
            ...
            <p>We may update these Terms and Conditions periodically. Updates will be published on the Platform. Continued use of Peakpay constitutes acceptance of the revised terms.</p>
          </div>
